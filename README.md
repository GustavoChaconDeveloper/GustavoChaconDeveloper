...
que ajudam a simplificar o dia a dia. Gosto de criar soluções práticas que realmente fazem a diferença,
tornando os processos mais ágeis e eficientes.
<br><br>
Tenho o hábito de separar um tempo da minha semana para estudar e me aperfeiçoar constantemente,
sempre em busca de novos conhecimentos. Também desenvolvo projetos para clientes,
unindo aprendizado e experiência prática, além de ser uma forma de renda extra.
</p>
...
<ul>
  ...
  <li>Telefonia VoIP (SIP)</li>
  <li>Docker para criação e gerenciamento de containers</li>
  <li>Administração de VPS, Windows Server, WordPress, domínios e hospedagem</li>
  <li>Criação e geração de relatórios técnicos</li>
</ul>
